...
1. Pillow:  run -> pip install Pillow
2. Custom Tkinter:  run -> pip install customtkinter
3. Packaging:  run -> pip install packaging

[>] Running Instructions
- Recommended Editor: Microsoft Visual Studio Code (VS Code)
- Open the entire directory in the Editor
